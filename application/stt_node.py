...
#"가줘:5.0", "가자:5.0", "가고:1.0", "데려다줘:5.0", "이동:5.0", "갈래:5.0", "가고싶어:5.0", "가야돼:5.0","바꿔:5.0", "목적지:5.0", "변경:5.0", "바꿔줘", "바꿀래", "변경할", "변경해", "다시",
boosted_keywords = [
    ...
    "네:5.0","네네:5.0", "예:5.0", "그래:5.0", "응:5.0", "맞아:5.0", "맞습니다:5.0", "그렇습니다:5.0", "좋아",
